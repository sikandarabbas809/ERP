			...
			<div class="col-md-9">
				<div class="row _newqouta">
					<div class="col-md-4 mt-10">
						...
						<button class="btn btn-primary rounded-pill px-5" data-toggle="modal" data-target="#add-client">Add Client</button>
						...
						<tbody class="tbody">
                            ...
                            <tr class="sub_c">
                                ...
                                <td align="right" colspan="6">
                                	<input type="submit" class="btn btn-success sub-btn btn-lg mt-20" value=" Generate Invoice " id="submit-data">
                                </td>
                            </tr>
						</tbody>
					</table>
