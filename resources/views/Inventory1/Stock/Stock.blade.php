			...
			<div class="col-md-9">
				<div class="row _newqouta">
					<div class="col-md-4 mt-10">
						...
						<button class="btn btn-primary rounded-pill px-5" data-toggle="modal" data-target="#add-supplier">Add Supplier</button>

						<!-- add client modal -->
						@include('layouts.partials-modal.add_suppliermodal')
						<!-- end client model -->
