				...
				<div class="card card-block">
			        ...
			        <form method="post" action="{{route('product.store')}}" enctype="multipart/form-data">
			            ...
			            <div class="card card-block">
			                ...
			                <div class="form-group row">
			                    <div class="col-sm-4">
			                        <div class="input-group">
			                            <input type="text" name="tax_rate" class="form-control" placeholder="Default TAX Rate" aria-describedby="sizing-addon1" onkeypress="return isNumber(event)"><span class="input-group-addon">%</span>
			                        </div>
			                    </div>
			                    <div class="col-sm-4">
			                        <div class="input-group">
			                            <input type="text" name="discount_rate" class="form-control" placeholder="Default Discount Rate" aria-describedby="sizing-addon1" onkeypress="return isNumber(event)">
			                ...
			                <div class="form-group row">
			                    <div class="col-sm-4">
			                        <input type="number" placeholder="Stock Units*" class="form-control margin-bottom" required="" name="qty" onkeypress="return isNumber(event)">
			                    </div>
			                    <div class="col-sm-4">
			                        <input type="number" placeholder="Alert Quantity" class="form-control" name="alert_qty" required=""  onkeypress="return isNumber(event)">
			                    </div>
			                </div>
			                <hr>
			                <div class="form-group row">
			                    <label class="col-sm-2 text-center">
			                        BarCode</label>
			                    <div class="col-sm-4">
			                        <input type="text" placeholder="BarCode 12 Numeric Digit 123-1-1234567-1" class="form-control margin-bottom" name="barcode" onkeypress="return isNumber(event)">
			                ...
			                <div class="form-group row">
			                    ...
			                    <div class="col-sm-8">
			                        <input placeholder="Employee Bonus" class="form-control margin-bottom" name="emp_bonus" onkeypress="return isNumber(event)">
