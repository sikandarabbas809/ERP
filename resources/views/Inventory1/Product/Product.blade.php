				...
				<div class="card card-block border-0">
			        ...
			        <div class="grid_3 grid_4 animated fadeInRight">
			            <h5 class="mt-20" style="font-weight: 600;">Products 
			         		<a href="{{url('/product/create')}}" class="btn btn-primary btn-sm rounded">Add new</a>
			            </h5>
				            ...
				            <tr>
				               ...
				               <td>
				               	<input type="hidden" name="user_id" value="{{$rows->id}}">
	                               	...
	                               	<a href="" data-object-id="" onclick="return confirm('Are you sure you want to remove this data?')"  class="btn btn-danger btn-xs "><span class="icon-bin"></span> Delete</a>
	                            </td>
				            </tr>
				            @endforeach
